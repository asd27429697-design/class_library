...
public class LibraryService {
    ...
    // (인터페이스 먼저 설계) - 이단원에서는 생략 X
    // service 하나가 DAO 세 개를 소유할 수 있습니다.
    ...
    // 1. 학번이 비어있는지 검사
    // 2. DAO에서 해당 학번을 찾는다
    // 3. 찾으면 Student 를, 없으면 null 을 그대로 View 에 돌려준다.
